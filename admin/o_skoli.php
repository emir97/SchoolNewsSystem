...
<head>
    ...
    if(isset($_GET[base64_url_encode("stranica")])){
        if(base64_url_decode($_GET[base64_url_encode("stranica")]) == "oNama"){
            $page="oNama";
            $title ="O Nama";
        } else if(base64_url_decode($_GET[base64_url_encode("stranica")]) == "rijeciDirektora"){
            $page = "rijeciDirektora";
            $title = "Riječi direktora";
        } else if(base64_url_decode($_GET[base64_url_encode("stranica")]) == "pravilaSkole"){
            $page = "pravilaSkole";
            $title = "Pravila škole";
        } else {
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-inline mb10">
                                                        ...
                                                        <?php
                                                        $staUpisat = "o_skoli.php?".base64_url_encode("stranica")."=".base64_url_encode($page)."&".base64_url_encode("edit")."=".base64_url_encode($page);
                                                         echo '
                                                        ...
                                                        if(isset($_GET[base64_url_encode("stranica")])){
                                                            ...
                                                            if($stranica == "oNama"){
                                                                ...
                                                                $fetchUpisData = $connect->query("SELECT * FROM podaci_o_skoli WHERE o_skoli_link_title = 'oNama' LIMIT 1");
                                                                if($fetchUpisData->rowCount() > 0){
                                                                    while ($r = $fetchUpisData->fetch(PDO::FETCH_OBJ)) {
                                                                        ...
                                                                        $upisTitle = $r->o_skoli_title;

                                                                        $upisContent = $r->o_skoli_content;

                                                                        $upisDate = new DateTime($r->o_skoli_date_upload);
                                                            ...
                                                            } else if($stranica == "rijeciDirektora") {
                                                                
                                                                $fetchUpisData = $connect->query("SELECT * FROM podaci_o_skoli WHERE o_skoli_link_title = 'rijeciDirektora' LIMIT 1");
                                                                if($fetchUpisData->rowCount() > 0){
                                                                    while ($r = $fetchUpisData->fetch(PDO::FETCH_OBJ)) {
                                                            ...
                                                            } else if($stranica == "pravilaSkole"){
                                                                $fetchUpisData = $connect->query("SELECT * FROM podaci_o_skoli WHERE o_skoli_link_title = 'pravilaSkole' LIMIT 1");
                                                                if($fetchUpisData->rowCount() > 0){
                                                                    while ($r = $fetchUpisData->fetch(PDO::FETCH_OBJ)) {
                                                        ...
                                                        ?>
                                                         ...
                                                         <?php if(isset($_GET[base64_url_encode("edit")])){
                                                            $action = "php/o_skoli_control.php?".base64_url_encode("whatUpload")."=".base64_url_encode($page);
                                                            echo '
