...
<?php
    ...
    // provjera da li stranica poslata u url
    if(isset($_GET['page'])) { 
        // dohvatanje podatka o kojoj je stranici rijec
        if($_GET['page'] == "o nama"){
            // dodavanje imena stranici za bazu
            $linkTitle = "oNama";
        } else if($_GET['page'] == "rijeci direktora"){
            // dodavanje imena stranici za bazu
            $linkTitle = "rijeciDirektora";
        } else if($_GET['page'] == "pravila skole") {
            // dodavanje imena stranici za bazu
