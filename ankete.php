        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active">Ankete</span></h6>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="widget-main">
                            <div class="widget-inner">
                                ...
                                <h3 class="archive-title">Ankete</h3>
                                <?php 
                                    $connect = connectOnDb();
                                    ...
                                    if($fetchPoll->rowCount() > 0) {
                                        ...
                                        foreach ($fetchPoll as $key => $value) {
                                            echo '<li>';
                                            echo '<a href="rezultat_ankete.php?pollID='.$value['anketa_pitanje_id'].'">';
                                            echo $value['anketa_pitanje_naslov'];
                                            echo '</a></li>';
                                        }
                                         echo "</ul>";
                                    }
